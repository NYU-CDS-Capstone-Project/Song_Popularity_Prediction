...
if __name__ == '__main__':
    ...
    threshold_source = 'MedleyDB'  # 'MedleyDB' or 'MagnaTagATune'  'MedleyDB' is for frame-level
    ...
    std_list = [StandardScaler() for std_fp in std_list] # initial StandardScaler() bz
