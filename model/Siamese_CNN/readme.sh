...
# mv mels/*.npy test_data/xte.npy #not works for trainning
...
# python3 cnn.ret30.fc.py -i train_data/ -ps -o ret30 -tg -t incept #input is just pure mel spectrum and tags
#for train 
